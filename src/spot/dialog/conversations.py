...
class GameStartStep:
    ...
    STATEMENTS: ClassVar[Tuple[str, ...]] = ("Hoi, mijn naam is Robin. Hoe heet jij?!",
                                             ...
                                             "Het werkt als volgt. We gaan de vrienden 1 voor 1 langs. Jij vertelt wie je op \pau=100\ elke plek ziet, en dan vertel ik \pau=30\ op welke plek die staat \pau=10\ in \pau=10\ mijn plaatje. Als we goed overleggen, vinden we samen de juiste antwoorden en is onze skore hoger! Leuk toch?",
...
class IntroStep:
    ...
    STATEMENTS: ClassVar[Tuple[str, ...]] = ("Beschrijf nu maar aan mij, wie er bij jou, op de \pau=20\ eerste plek \pau=10\ staat, zodat ik begrijp wie je bedoelt. Dat is de plek met het cijfer 1 erboven. Je kunt bijvoorbeeld aan mij vertellen \pau=20\ hoe hun gezicht er \pau=20\ uit ziet, of iets anders \pau=25\ dat opvalt",
